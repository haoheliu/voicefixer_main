...
from single_task_speech_restoration.enh_unet.model_kqq_lstm_mask_gan.model_kqq import UNetResComplex_100Mb
...
class DNN(pl.LightningModule):
    ...
    def training_step(self, batch, batch_nb):
        ...
        _, self.LR, self.LR_noisy = self.preprocess(batch, train=True)

        for i in range(self.LR.size()[0]):
        ...
        targ_loss = self.f_loss(self.generated['wav'], self.LR)
