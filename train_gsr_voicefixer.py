...
trainer = Trainer.from_argparse_args(args,
                                     ...
                                     checkpoint_callback=True, logger=logger, log_every_n_steps=hp["log"]["log_every_n_steps"],
                                     progress_bar_refresh_rate=hp["log"]["progress_bar_refresh_rate"], flush_logs_every_n_steps=hp["log"]["flush_logs_every_n_steps"])
dm.setup('fit')
