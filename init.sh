...
if [ ! -d "datasets/se/wav48" ]; then
  ...
  if [ ! -f "datasets/se/vctk.tar" ]; then
    wget https://zenodo.org/record/5528132/files/vctk.tar?download=1 -O datasets/se
  fi
...
if [ ! -d "datasets/se/vd_noise" ]; then
  ...
  if [ ! -f "datasets/se/vd_noise.tar" ]; then
    wget https://zenodo.org/record/5528132/files/vd_noise.tar?download=1 -O datasets/se
  fi
...
if [ ! -d "datasets/se/Testsets" ]; then
  ...
  if [ ! -f "datasets/se/GSR_and_SSR_testsets.zip" ]; then
    wget https://zenodo.org/record/5528144/files/GSR_and_SSR_testsets.zip?download=1 -O datasets/se
  fi
