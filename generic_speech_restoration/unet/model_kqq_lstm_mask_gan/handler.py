...
def handler(input, output, target, ckpt, device, needrefresh=False):
...
if __name__ == '__main__':
    models = {
        "2.12.2.all_unet": "iclr_2022/unet/model_kqq_lstm_mask_gan/a1982_log/2021-07-14-unet-#vocalsnoise#-#vctkvd_noisevocal_wav_44kdcasehq_ttsnoise_44k#-#vd_test#-fixed_4k_44k_mask_gan-l1#1500_44100#/version_14/checkpoints/epoch=10.ckpt",
        "2.12.2.all_unet_fix_bug": "iclr_2022/unet/model_kqq_lstm_mask_gan/a1982_log/2021-07-18-unet-#vocalsnoise#-#vctkvd_noisevocal_wav_44kdcasehq_ttsnoise_44k#-#vd_test#-fixed_4k_44k_mask_gan-l1#1500_44100#/version_0/checkpoints/epoch=9.ckpt",
    }

    key = "2.12.2.all_unet_fix_bug"
